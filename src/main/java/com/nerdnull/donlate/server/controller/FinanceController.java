...
public class FinanceController {
    ...
    @Autowired
    public FinanceController(ExchangeService exchangeService) {
    ...
    public Response<String> exchange(@RequestBody ExchangeRequest request){
        try {
            ...
            ExchangeDto exchangeDto = new ExchangeDto(null, request.getAccount(), request.getAmount(), request.getNickName(), null);
